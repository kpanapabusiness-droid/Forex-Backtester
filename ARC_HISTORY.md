...
- **Source closure doc:** `results/l_arc_1/step3_extractability/PHASE_L_ARC_1_STEP3_S15_OUTCOME.md` (referenced by `archive/L_ARC_PROTOCOL_v1_1_AMENDMENT.md`); v1.x WFO closure material in `docs/PHASE_L6_ARC1_OPEN.md` (now docs/archive/nnfx_era/) and `docs/CANDIDATES.md` (now docs/archive/nnfx_era/). Closure doc status: **partially preserved** — calibration-check FAIL outcome referenced but no standalone `ARC_1_RESULT.md` exists.
