...
- **Daily DD:** static-initial (default; `daily_ref="static"` — % of the tier's initial balance). `day_start` (intra-day high-water reset) selectable.
