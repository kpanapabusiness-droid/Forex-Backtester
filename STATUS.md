...
> Last updated: 2026-05-19 — **Arc 8** (PR-HHHL long) CLOSED 2026-05-18 HALT_DEPLOYMENT — Steps 1-4 PASS, Step 5 WFO FAIL §10 (admit-only PASS, full-pool FAIL); c1 V-shape recovery FG-weak archetype logged for Open-05; **3rd consecutive Open-22/23/24 admit-only-vs-deployment failure** (Arcs 4 RERUN, 5, 8); proposed v2.4 §1.5 entry-separability gate added to backlog as Open-25. **Arc 9** CLOSED STEP_4_KILL_REAFFIRMED after producer-leak patch invalidated held-open Pipeline E retry's AUC 0.7508 (was a leak artefact; patched AUC 0.5190 below §8 gate); cohort verified deployable in Step 5 oracle but unreachable on causally-clean features; v2.x amendment proposal revised (§8 D1 feature-budget expansion WITHDRAWN; §3 threshold-grid replacement WEAKENED; NEW Amendment 1 = producer-level causal audit dimension as highest priority); closure `results/l_arc_9/ARC_9_CLOSURE.md`, incident `results/l_arc_9/INCIDENT_2026_05_19_ARC_9_PRODUCER_LEAK.md`. **Arc 11** (SHB long 4H) CLOSED-HALT per §16a Path A (best AUC 0.5728, margin 0.027); second confirmed capturable-not-extractable closure (pairs with Arc 6); 4 post-closure experimental sessions retired 8 directions and filed Pipeline DE + `min_observation_bars` as v2.4 amendment candidates; closure `results/l_arc_11/ARC_11_CLOSURE.md`. Sibling Arc 10 still in flight in parallel CC chat. Engine PR `feat/open-24-pre-t-sl-per-archetype` (Open-24) merged 2026-05-19 (PR #146). Prior context: 2026-05-18 L_ARC_PROTOCOL v2.3 amendment landed (Step 5 cross-fold stability removed; Step 6 WFO renumbered as Step 5; Open-22/23/24 closed in protocol); v2.2 amendment landed earlier same day; Arcs 4, 5, 6, 7 all closed. KH-24 live deployment unchanged.
...
| Current arc | None active in this worktree — Arc 8 closed HALT_DEPLOYMENT 2026-05-18; Arc 9 closed STEP_4_KILL_REAFFIRMED 2026-05-19; Arc 11 closed HALT 2026-05-18; Arc 10 in flight in parallel CC chat |
