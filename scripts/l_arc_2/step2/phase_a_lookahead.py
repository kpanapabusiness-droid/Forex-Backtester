...
from scripts.l_arc_2.step2._io import (
    FORWARD_HORIZON_BARS_DEFAULT, PAIRS, STEP2_DIR, hash_seed,
    load_pair_1h, load_trades_verbatim,
)
from scripts.l_arc_2.step2.phase_a_features import (
    _pre_signal_context, compute_path_aggregates, per_trade_full_path,
)
...
def write_feature_lag_audit(H: int = FORWARD_HORIZON_BARS_DEFAULT) -> Path:
    ...
    lines = [
        ...
        f"  - For each trade, fwd_* aggregates use ONLY bars [entry_idx, entry_idx+H-1].",
