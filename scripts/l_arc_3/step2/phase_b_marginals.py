...
For arc 3 the held window is REAL (mean ~47 bars, max 120); none of arc 1's
...
def run_phase_b() -> None:
    ...
    # §5.1 marginals — REAL on arc 3 (held window > 1 bar)
    ...
    # §5.6 survival curves — REAL on arc 3 (time-exit h=120, SL hit possible at any held bar)
