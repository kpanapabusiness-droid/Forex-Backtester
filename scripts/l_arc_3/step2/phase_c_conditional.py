...
def run_phase_c() -> None:
    ...
    strata = [
        ...
        # Arc-3 NEW pre-signal context axes (§5.9 extension)
        ("cum_logret_1h_24_bin", "cum_logret_1h_24_bin"),
        ("cum_logret_1h_168_bin", "cum_logret_1h_168_bin"),
        ("vol_realized_1h_24h_decile", "vol_realized_24h_decile"),
        ("cum_logret_1h_6_bin", "cum_logret_1h_6_bin"),
    ]
    ...
    heatmap("mfe_held_atr", "bars_held", 30, 12, "mfe_held__bars_held")
    heatmap("mae_held_atr", "bars_held", 30, 12, "mae_held__bars_held")
    heatmap("mfe_held_atr", "time_to_peak_mfe", 30, 30, "mfe_held__time_to_peak_mfe")
    heatmap("mfe_held_atr", "exit_reason", 30, 1, "mfe_held__exit_reason")
    heatmap("net_r", "bars_held", 30, 12, "net_r__bars_held")
    heatmap("net_r", "oscillation_count", 30, 20, "net_r__oscillation_count")
    heatmap("first_bar_direction", "net_r", 1, 30, "first_bar_direction__net_r")
    heatmap("mfe_sequence_class_held", "net_r", 1, 30, "mfe_sequence_class_held__net_r")
