...
def main() -> int:
    ...
    target_rule_str = (
        "v1.2 A2: target = highest median fwd_mae_h24_atr; mirror = highest median fwd_mfe_h24_atr"
    )
            ...
            target_rows.append(
                {
                    "algo": algo,
                    "K": k,
                    "target_cluster_id": t["cid"],
                    "target_cluster_size": t["n"],
                    ...
                    "mirror_cluster_id": m["cid"],
                    "mirror_cluster_size": m["n"],
        ...
        target_rows.append(
            {
                ...
                "mirror_cluster_id": -999,
                "mirror_cluster_size": 0,
