...
def test_resolve_signal_list_all() -> None:
    ...
    discovered = [
        "indicators.confirmation_funcs:c1_coral",
        "indicators.confirmation_funcs:c1_supertrend",
    ]
...
def test_derive_metrics_long_only_uses_long_rate() -> None:
    ...
    stab = pd.DataFrame(
        [
            _make_stability_row(
                "sig_long", "long", 2, 3.0, n_signal_discovery=50, signal_rate_discovery=0.45
            ),
            _make_stability_row(
                "sig_long", "short", 2, 3.0, n_signal_discovery=0, signal_rate_discovery=0
            ),
            _make_stability_row(
                "sig_long", "long", 2, 4.0, n_signal_discovery=50, signal_rate_discovery=0.25
            ),
            _make_stability_row(
                "sig_long", "short", 2, 4.0, n_signal_discovery=0, signal_rate_discovery=0
            ),
        ]
    )
...
def test_derive_metrics_p4r_long_only() -> None:
    ...
    stab = pd.DataFrame(
        [
            _make_stability_row(
                "sig_a", "long", 2, 4.0, n_signal_discovery=60, signal_rate_discovery=0.5
            ),
            _make_stability_row(
                "sig_a", "short", 2, 4.0, n_signal_discovery=0, signal_rate_discovery=0
            ),
        ]
    )
        ...
        for x, y in [(1, 2.0), (2, 3.0), (2, 4.0)]:
            ...
            rows.append(
                _make_stability_row(
                    ...
                    x,
                    y,
                    n_signal_discovery=40,
                    signal_rate_discovery=sr_d,
                    signal_rate_validation=sr_d * 0.9,
                )
            )
            rows.append(
                _make_stability_row(
                    ...
                    x,
                    y,
                    n_signal_discovery=0,
                    signal_rate_discovery=0,
                    signal_rate_validation=0,
                )
            )
...
def test_leaderboard_geometry_lock_sorts_by_p_3r_before_2r() -> None:
    ...
    stab_rows = [
        _make_stability_row(
            ...
            2,
            3.0,
            n_signal_discovery=35,
            signal_rate_discovery=0.7,
            n_signal_validation=30,
            signal_rate_validation=0.65,
        ),
        _make_stability_row(
            "sig_high",
            "short",
            2,
            3.0,
            n_signal_discovery=5,
            signal_rate_discovery=0.4,
            n_signal_validation=5,
            signal_rate_validation=0.35,
        ),
        _make_stability_row(
            "sig_high",
            ...
            4.0,
            n_signal_discovery=35,
            signal_rate_discovery=0.5,
            n_signal_validation=30,
            signal_rate_validation=0.48,
        ),
        _make_stability_row(
            "sig_high",
            "short",
            ...
            4.0,
            n_signal_discovery=5,
            signal_rate_discovery=0.3,
            n_signal_validation=5,
            signal_rate_validation=0.28,
        ),
        _make_stability_row(
            "sig_high",
            "long",
            ...
            2.0,
            n_signal_discovery=35,
            signal_rate_discovery=0.6,
            n_signal_validation=30,
            signal_rate_validation=0.55,
        ),
        _make_stability_row(
            "sig_high",
            "short",
            ...
            2.0,
            n_signal_discovery=5,
            signal_rate_discovery=0.35,
            n_signal_validation=5,
            signal_rate_validation=0.3,
        ),
        _make_stability_row(
            "sig_low",
            "long",
            2,
            3.0,
            n_signal_discovery=8,
            signal_rate_discovery=0.25,
            n_signal_validation=7,
            signal_rate_validation=0.2,
        ),
        _make_stability_row(
            "sig_low",
            "short",
            2,
            3.0,
            n_signal_discovery=2,
            signal_rate_discovery=0.1,
            n_signal_validation=2,
            signal_rate_validation=0.08,
        ),
        _make_stability_row(
            "sig_low",
            "long",
            ...
            4.0,
            n_signal_discovery=8,
            signal_rate_discovery=0.15,
            n_signal_validation=7,
            signal_rate_validation=0.12,
        ),
        _make_stability_row(
            "sig_low",
            "short",
            ...
            4.0,
            n_signal_discovery=2,
            signal_rate_discovery=0.05,
            n_signal_validation=2,
            signal_rate_validation=0.04,
        ),
        _make_stability_row(
            "sig_low",
            "long",
    ...
    stab = pd.DataFrame(
        [
            _make_stability_row(
                ...
                n_signal_discovery=2,
                signal_rate_discovery=0.5,
                n_signal_validation=1,
                signal_rate_validation=0.4,
            ),
            _make_stability_row(
                "sig_sparse",
                "short",
    ...
    stab = pd.DataFrame(
        [
            _make_stability_row(
                ...
                2,
                3.0,
                n_signal_discovery=60,
                signal_rate_discovery=0.45,
                baseline_rate_discovery=0.30,
                n_signal_validation=50,
                signal_rate_validation=0.42,
                baseline_rate_validation=0.28,
            ),
            _make_stability_row(
                "sig_mock",
                "short",
                ...
                3.0,
                n_signal_discovery=50,
                signal_rate_discovery=0.40,
                baseline_rate_discovery=0.28,
                n_signal_validation=45,
                signal_rate_validation=0.38,
                baseline_rate_validation=0.26,
            ),
            _make_stability_row(
                "sig_mock",
                "long",
            ...
            _make_stability_row(
                ...
                2.0,
                n_signal_discovery=60,
                signal_rate_discovery=0.55,
                n_signal_validation=50,
                signal_rate_validation=0.52,
            ),
            _make_stability_row(
                "sig_mock",
                "short",
...
def test_p4r_secondary_protection_rejection() -> None:
    ...
    stab = pd.DataFrame(
        [
            _make_stability_row(
                ...
                2,
                3.0,
                n_signal_discovery=80,
                signal_rate_discovery=0.4,
                n_signal_validation=70,
                signal_rate_validation=0.38,
            ),
            _make_stability_row(
                "sig_test",
                ...
                2,
                3.0,
                n_signal_discovery=55,
                signal_rate_discovery=0.35,
                n_signal_validation=50,
                signal_rate_validation=0.32,
            ),
            _make_stability_row(
                "sig_test",
                "long",
                ...
                4.0,
                n_signal_discovery=80,
                signal_rate_discovery=0.65,
                n_signal_validation=70,
                signal_rate_validation=0.05,
            ),
            _make_stability_row(
                "sig_test",
                "short",
    ...
    drop = (row["P_4R_before_2R_disc"] - row["P_4R_before_2R_val"]) / max(
        row["P_4R_before_2R_disc"], 1e-12
    )
    assert drop > 0.10
